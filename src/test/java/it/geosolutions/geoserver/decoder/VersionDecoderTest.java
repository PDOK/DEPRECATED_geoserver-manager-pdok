...
public class VersionDecoderTest extends GeoserverRESTTest {
    ...
    public void testVersionDecoder() {
        ...
        Assert.assertEquals(VERSION.UNRECOGNIZED, dec.getVersion());
    ...
    public void testIntegrationVersionDecoder() {
        ...
        if (VERSION.v22.equals(VERSION.getVersion(GS_VERSION))) {
            Assert.assertEquals(geoserver.getVersion(), VERSION.v22);
        } else if (VERSION.UNRECOGNIZED.equals(VERSION
                .getVersion(GS_VERSION))) {
            Assert.assertEquals(geoserver.getVersion(), VERSION.UNRECOGNIZED);
        }
        // print(dec.getRoot());
    }
